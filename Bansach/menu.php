...
<body>
    ...
    <div class="menu">
        ...
        <ul>
            <li>
                <div class="main-menu">
                    <a class="layer1" href="index.php" style="font-size: 23;"><i ></i> <b>Trang chủ</b></a>
                </div>
            </li>
            <li>
                <div class="main-menu">
                    <a class="layer1" href="#" style="font-size: 23;"><i ></i> <b>Tác giả</b></a>
                    <div class="layer2">
                        <ul>
                            <?php
            ...
            <li>
                <div class="main-menu">
                    <a class="layer1" href="#" style="font-size:23;"><i ></i> <b>Sắp xếp</b></a>
                    <div class="layer2">
                                <ul>
            ...
            <li>
                <div class="main-menu">
                    <a class="layer1" href="cart.php" style="font-size:23;"><i ></i> <b>Giỏ hàng</b></a>
                </div>
            </li>
        </ul>
    </div>
