...
<body>
    ...
    ?>
        <div class="container">
            <a class="fas fa-reply-all" href="<?php if ($_SESSION['txtTK'] == "admin") $tb = "bill_admin.php";
                        else $tb = "bill.php";
                        echo $tb; ?>">Quay lại</a>
            <h1>Chi tiết đơn hàng</h1>
            <h3>Người nhận: <?=$kq1['Ten']?></h3>
            <h3>Địa chỉ: <?=$kq1['DiaChi']?></h3>
            <h3>Số điện thoại: <?=$kq1['SDT']?></h3>
            <form id="cart-form" action="" method="POST">
                <table align="center">
                    ...
                    <?php
                    $num = 1;
                    $sql = "select * from ctgh where MaHD ='" . $_GET['MaHD'] . "'";
                    ...
                    ?>
                        ...
                        <td class="money"><?=number_format($ttien, 0, ",", ".") ?></td>
                        </tr>
                    <?php
                        $num++;
                    }
