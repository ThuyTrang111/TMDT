				...
				<tr>
				 ...
				 <tr>
                        ...
                        <td>
                            ...
                            <input type="text" value="<?php echo $result_product['tacgia'] ?>" name="tacgia" class="medium" />
                        </td>
                    </tr>
					 <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" value="<?php echo $result_product['nxb'] ?>" name="nxb" class="medium" />
                        </td>
                    </tr>
					 <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" value="<?php echo $result_product['namxb'] ?>" name="namxb"  class="medium" />
                        </td>
                    </tr>
					 <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" value="<?php echo $result_product['trongluong'] ?>" name="trongluong" class="medium" />
                        </td>
                    </tr>
					 <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" value="<?php echo $result_product['kichthuoc'] ?>" name="kichthuoc" class="medium" />
                        </td>
                    </tr>
					 <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" value="<?php echo $result_product['trang'] ?>" name="trang" class="medium" />
                        </td>
                    </tr>
				 <tr>
